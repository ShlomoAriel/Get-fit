...
const Session = ({form, traineeId, traineeList, sessionList, onInputFieldChange, onChange, addSession, removeGoal, setCurrentTrainee, toggleModal}) => {
	let formFields = {}
    ...
    formFields['textInput'] = { type: 'input', fieldClass:'form-control',field: 'title', name:'title', placeholder: 'title', value: form.title, onUpdate: onInputFieldChange }
